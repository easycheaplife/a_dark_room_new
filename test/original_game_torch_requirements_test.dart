...
import '../lib/modules/setpieces.dart';
...
void main() {
  group('原游戏火把需求验证测试', () {
    ...
    test('验证当前实现的setpiece列表', () {
      ...
      // 验证基本setpieces存在
      expect(availableSetpieces.contains('cave'), true, reason: '洞穴setpiece应该存在');
      
      // 记录哪些原游戏setpieces还未实现
      final originalGameSetpieces = ['cave', 'town', 'city', 'ironmine', 'coalmine', 'sulphurmine'];
      final missingSetpieces = originalGameSetpieces.where((s) => !availableSetpieces.contains(s)).toList();
