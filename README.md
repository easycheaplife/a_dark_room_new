...
**最后更新**: 2025-01-11
**事件系统修复**: 修复侦察兵事件购买地图和学习技能按钮点击后立即关闭事件的问题
**多次购买支持**: 实现与原游戏一致的事件交互机制，支持多次购买和学习
**事件处理优化**: 修复事件按钮处理逻辑，正确区分结束事件和继续交互的按钮
**用户体验改善**: 侦察兵、商人等事件现在支持多次交互，符合原游戏设计
**测试验证**: 新增侦察兵事件多次购买测试，确保修复的正确性
**代码质量**: 提升事件系统的健壮性，适用于所有类似的交互事件
